...
public class KasaTipTypeConfiguration : IEntityTypeConfiguration<KasaTip>
{
    public void Configure(EntityTypeBuilder<KasaTip> builder)
    {
        builder.ToTable("kasa_tipleri", "envanter");

        builder.HasKey(x => x.Id).HasName("kasa_tipleri_pkey");
